...
public class Pcap extends KaitaiStruct {
    ...
    public Pcap(KaitaiStream _io) {
        super(_io);
    	System.out.println(this._io.getClass());
        this._root = this;
...
//        _read();
    ...
    public Packet _read() {
        ...
        while (!this._io.isEof()) {
        	return new Packet(this._io, this, _root);
        }
		return null;
    }
    ...
    public static class Packet extends KaitaiStruct {
        ...
        private void _read() {
            ...
            case RAW: {
            	this._raw_body = this._io.readBytes(inclLen());
            	KaitaiStream _io__raw_body = new KaitaiStream(_raw_body);
            	byte ipv =  (byte) (_raw_body[0] & 0xf0);
            	switch (ipv) {
            	case 0x40: {
            		this.ipVersion = 4;
...
//            	System.out.println(String.format("%02X ", _raw_body[0] & 0xf0));
            	break;
            }
            default: {
        ...
        public int ipv() {return ipVersion;};
